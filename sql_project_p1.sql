...
-- HOW MANY CATEGORY AND TOTAL NUMBER OF CATEGORY IS THERE?
SELECT DISTINCT category FROM retail_sales;
	#AND
SELECT COUNT(DISTINCT category) FROM retail_sales;

-- DATA ANALYTICS AND KEY BUSINESS PROBLEMS AND SOLUTION
...
-- Q.9 Write a SQL query to find the number of unique customers who purchased items from each category.
SELECT 
	COUNT(DISTINCT customer_id) AS unique_cust, category
 FROM retail_sales
 GROUP BY category;
